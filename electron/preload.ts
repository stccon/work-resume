...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  getUiTheme: () => ipcRenderer.invoke("ui-theme:get") as Promise<"light" | "dark">,
  setUiTheme: (mode: "light" | "dark") => ipcRenderer.invoke("ui-theme:set", mode),
  getCurrentVisualTheme: () => ipcRenderer.invoke("visual-theme:get") as Promise<string | null>,
  setCurrentVisualTheme: (name: string) => ipcRenderer.invoke("visual-theme:set", name),
