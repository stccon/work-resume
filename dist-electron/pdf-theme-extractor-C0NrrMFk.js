...
const pdfExtractor = require("./pdf-extractor-h1cLj59h.js");
pdfExtractor.GlobalWorkerOptions.workerSrc = path.join(__dirname, "..", "node_modules", "pdfjs-dist", "build", "pdf.worker.min.js");
...
async function detectColors(filePath, style) {
  ...
  try {
    ...
    const doc = await pdfExtractor.getDocument({ data, useWorkerFetch: false, useSystemFonts: false }).promise;
